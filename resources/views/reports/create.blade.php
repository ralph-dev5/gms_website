    ...
    <div class="min-h-screen flex flex-col items-center justify-center bg-gray-50 p-4 md:p-10">
        <div class="bg-white w-full max-w-4xl rounded-3xl shadow-2xl overflow-hidden border border-gray-100">
            ...
            <form method="POST" action="{{ route('reports.store') }}" enctype="multipart/form-data"
                class="p-8 space-y-8" id="reportForm">
                @csrf

                <div class="grid grid-cols-1 md:grid-cols-2 gap-8">
                    <div class="space-y-6">
                        <div>
                            <label class="block text-sm font-black text-gray-700 uppercase tracking-wider mb-2">Target
                                Street</label>
                            <div class="relative">
                        ...
                        <div>
                            <label class="block text-sm font-black text-gray-700 uppercase tracking-wider mb-2">Evidence
                                Photo</label>
                            <label
                                class="flex flex-col items-center justify-center w-full h-32 border-2 border-dashed border-gray-200 rounded-xl cursor-pointer hover:bg-gray-50 transition"
                                id="photo-label">
                    ...
                    <div class="space-y-4">
                        <div class="flex justify-between items-center">
                            <label class="text-sm font-black text-gray-700 uppercase tracking-wider">Pin
                                Location</label>
                        ...
                        <div id="map" class="w-full h-64 md:h-80 rounded-2xl border-2 border-gray-100 shadow-inner">
                        </div>
                        ...
                        <div class="p-3 bg-gray-50 rounded-lg border border-gray-100" id="location-display">
                            <p class="text-xs text-gray-500 italic text-center">Click <strong>"Use My Location"</strong>
                                or tap the map to pin your location.</p>
                        </div>
                    </div>
                </div>
