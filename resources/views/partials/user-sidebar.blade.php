<!-- USER SIDEBAR -->
<!-- Mobile toggle button - moves with user sidebar -->
<button id="user-toggle"
    onclick="document.getElementById('user-sidebar').classList.toggle('-translate-x-full'); this.classList.toggle('translate-x-64')"
