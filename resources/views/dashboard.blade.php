                                ...
                                <tr class="hover:bg-gray-50/50 transition-colors">
                                    ...
                                    <td class="p-4 text-sm">
                                        @if ($report->location)
                                            <a href="https://www.google.com/maps?q={{ $report->location }}"
                                                target="_blank" class="inline-flex items-center gap-1 text-blue-600 font-bold hover:text-blue-800 transition-colors text-xs">
                                    ...
                                    <td class="p-4 text-center">
                                        <form action="{{ route('reports.destroy', $report->id) }}" method="POST"
                                            ...
                                            @csrf
                                            @method('DELETE')
                                            <button class="text-red-400 hover:text-red-600 p-2 hover:bg-red-50 rounded-full transition-all">
                                ...
                                <tr>
                                    <td colspan="6" class="p-10 text-center">
                                        <div class="flex flex-col items-center">
                                            <svg class="w-12 h-12 text-gray-200 mb-3" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 5H7a2 2 0 00-2 2v12a2 2 0 002 2h10a2 2 0 002-2V7a2 2 0 00-2-2h-2M9 5a2 2 0 012-2h2a2 2 0 012 2m-6 9l2 2 4-4"/></svg>
